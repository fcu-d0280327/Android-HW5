...
public class NBAArrayAdapter extends ArrayAdapter<NBAitem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //host
        TextView hostName = (TextView)itemlayout.findViewById(R.id.itemtv_host);
        TextView hostScore = (TextView)itemlayout.findViewById(R.id.itemtv2_host);
        ImageView hostImg = (ImageView)itemlayout.findViewById(R.id.itemiv_host);
        ...
        //guest
        TextView guestName = (TextView)itemlayout.findViewById(R.id.itemtv_guest);
        TextView guestScore = (TextView)itemlayout.findViewById(R.id.itemtv2_guest);
        ImageView guestImg = (ImageView)itemlayout.findViewById(R.id.itemiv_guest);
